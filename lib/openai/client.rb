module OpenAI
  class Client
    ...
    def initialize(access_token: nil, organization_id: nil, uri_base: nil, request_timeout: nil, user_agent: nil)
      ...
      OpenAI.configuration.user_agent = user_agent if user_agent
    end
